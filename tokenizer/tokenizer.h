...
/*   Updated: 2025/07/28 09:05:29 by lduflot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*token_pipe_unclose(int *i, int start, char *line, t_token **token, t_ctx *ctx);
char	*token_logical_unclose(int *i, int start, char *line, t_token **token, t_ctx *ctx);
